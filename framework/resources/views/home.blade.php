...
<div class="row">
  ...
  <div class="col-12 col-sm-6 col-md-3">
    <div class="info-box">
      <span class="info-box-icon bg-gradient-dark"><i class="fa fa-users"></i></span>
  ...
  <div class="col-12 col-sm-6 col-md-3">
    <div class="info-box">
      <span class="info-box-icon bg-gradient-dark"><i class="fa fa-id-card"></i></span>
  ...
  <div class="col-12 col-sm-6 col-md-3">
    <div class="info-box">
      <span class="info-box-icon bg-gradient-dark"><i class="fa fa-address-card"></i></span>
      <div class="info-box-content">
  ...
  <div class="col-12 col-sm-6 col-md-3">
    <div class="info-box">
      <span class="info-box-icon bg-gradient-dark"><i class="fa fa-taxi"></i></span>
      <div class="info-box-content">
